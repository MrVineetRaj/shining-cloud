...
const Storage = () => {
  ...
  const [pngPercent, setPngPercent] = useState(0);
  const [svgPercent, setSvgPercent] = useState(0);
  const [jpgPercent, setJpgPercent] = useState(0);
  const [gifPercent, setGifPercent] = useState(0);

  useEffect(() => {
    setPngPercent(Math.floor(pngStorage * 2));
    setSvgPercent(Math.floor(svgStorage * 2));
    setJpgPercent(Math.floor(jpgStorage * 2));
    setGifPercent(Math.floor(gifStorage * 2));
  }, [update]);
